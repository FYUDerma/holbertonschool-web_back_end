...
def log_stats():
    ...
    This function connects to a MongoDB database, retrieves logs,
    and prints the total number of logs, the count of different HTTP
    methods, and the number of status check requests.
    """
    client = MongoClient()
